...
struct NbnxnPairlistCpu
{
    ...
    std::vector<nbnxn_ci_t>  ci;          /* The i-cluster list                       */
    std::vector<nbnxn_ci_t>  ciOuter;     /* The outer, unpruned i-cluster list       */

    std::vector<nbnxn_cj_t>  cj;          /* The j-cluster list, size ncj             */
    std::vector<nbnxn_cj_t>  cjOuter;     /* The outer, unpruned j-cluster list       */
