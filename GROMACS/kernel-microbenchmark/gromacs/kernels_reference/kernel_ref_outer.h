 ...
 nbnxn_atomdata_output_t    *out)
{
    ...
    const nbnxn_atomdata_t::Params &nbatParams = nbat->params_;
...
#if !GMX_DOUBLE
    tab_coul_FDV0 = ic->tabq_coul_FDV0.data();
#else
    tab_coul_F    = ic->tabq_coul_F.data();
    tab_coul_V    = ic->tabq_coul_V.data();
#endif
#endif
